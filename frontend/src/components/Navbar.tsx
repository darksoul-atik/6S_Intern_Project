...
export function Navbar() {
  ...
  |--------------------------------------------------------------------------
  |
  | We remember which pathname the menu was opened on.
  |
  | If navigation changes the pathname:
  |
  | mobileMenuPath !== pathname
  |
  | so mobileMenuOpen automatically becomes false.
  |
  | This avoids:
  |
  | useEffect(() => {
  ...
  | }, [pathname]);
  |
  | which React Compiler warns about.
  |--------------------------------------------------------------------------
  */
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Feed should remain highlighted on:
  |
  | /posts
  | /posts/new
  | /posts/:id
