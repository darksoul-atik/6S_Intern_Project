      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-16 py-8 sm:py-12">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8 animate-pulse">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-2 rounded-3xl border border-white/80 bg-white/70 p-6 sm:p-8 shadow-sm space-y-5">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              <div className="space-y-4 pt-2">
                <div className="rounded-2xl border border-slate-100 bg-slate-50/70 p-4 space-y-2.5">
                  <div className="flex justify-between items-center">
                    <div className="h-4 w-44 rounded-md bg-slate-200/90" />
                    <div className="h-4 w-24 rounded-md bg-slate-200/70" />
                  </div>
                  <div className="h-3 w-32 rounded-md bg-slate-200/70" />
                  <div className="h-3 w-full rounded-md bg-slate-200/60" />
                  <div className="h-3 w-3/4 rounded-md bg-slate-200/60" />
                </div>

                <div className="rounded-2xl border border-slate-100 bg-slate-50/70 p-4 space-y-2.5">
                  <div className="flex justify-between items-center">
                    <div className="h-4 w-36 rounded-md bg-slate-200/90" />
                    <div className="h-4 w-24 rounded-md bg-slate-200/70" />
                  </div>
                  <div className="h-3 w-28 rounded-md bg-slate-200/70" />
                  <div className="h-3 w-5/6 rounded-md bg-slate-200/60" />
                </div>
              </div>
            </div>
          </div>
