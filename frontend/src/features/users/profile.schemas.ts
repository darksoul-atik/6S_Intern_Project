...
const projectTechnologiesSchema = z
  .array(
    z
      .string()
      .trim()
...
export const portfolioProjectFormSchema = z
  ...
  .superRefine((project, ctx) => {
     ...
     *
     * "" is allowed inside the frontend form because later
     * we convert it to undefined before sending the API request.
     */
     ...
     *
     * YYYY-MM strings can safely be compared lexicographically:
     *
     * 2026-05 > 2025-12
     */
    if (
...
export const profileFormSchema = z.object({
  ...
  /*
   * Empty string means "clear headline" in the form.
   *
   * Before PATCH /profile/me:
   * "" -> null
   */
  headline: z
    .string()
  ...
  /*
   * Empty string means "clear bio" in the form.
   *
   * Before PATCH /profile/me:
   * "" -> null
   */
