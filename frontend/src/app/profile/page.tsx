...
export default function OwnProfilePage() {
  ...
  const updateAvatarMutation = useUpdateAvatarMutation('me');
  const deleteAvatarMutation = useDeleteAvatarMutation('me');
  ...
  const profileId = profile?.id || profile?._id || currentUser?.id;
  const isOwner = true;
  const canEdit = true;
  ...
  const handleShare = () => {
    if (typeof window !== 'undefined') {
      const shareUrl = profileId
        ? `${window.location.origin}/developers/${profileId}`
      ...
      <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 font-sans">
        <div className="max-w-md w-full rounded-3xl border border-slate-200/80 bg-white/90 p-8 text-center backdrop-blur-2xl shadow-xl space-y-4">
          ...
          <p className="text-sm text-slate-600 font-sans leading-relaxed">
            Please sign in to your DevPulse account to view and manage your profile.
          </p>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-5 sm:gap-6">
              ...
              <div className="flex flex-col items-center justify-center gap-2.5 shrink-0 self-center">
                <div className="relative group">
                  ...
                  {/* Quick Upload Hover Button for Owner */}
                  <button
                    type="button"
                ...
                {/* Owner Action buttons centered directly under avatar matching image width */}
              ...
              {profile.skills && profile.skills.length > 0 ? (
                ...
                <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 p-6 text-center space-y-2">
                  ...
                  <p className="text-xs text-slate-500 font-sans">
                    No skills listed yet. Add your competencies in the profile editor.
                  </p>
                </div>
              )}
            </motion.div>
            ...
            >
              ...
              {profile.experiences && profile.experiences.length > 0 ? (
                ...
                <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 p-8 text-center space-y-2">
                  ...
                  <p className="text-xs text-slate-500 font-sans">
                    No work experience listed yet. Add your career history in the profile editor.
                  </p>
                </div>
              )}
            </motion.div>
